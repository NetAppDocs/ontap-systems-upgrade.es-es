...
Para obtener otros métodos para actualizar el hardware de la controladora, consulte link:other_references.html["Referencias"] Para enlazar con _Upgrade moviendo volúmenes o Storage_.

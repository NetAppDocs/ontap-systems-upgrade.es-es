...
Después de arrancar node1 con el módulo de controlador de reemplazo, compruebe que está instalado correctamente. Debe esperar a que el nodo 1 se una al quórum y reanudar la operación de reemplazo de la controladora.

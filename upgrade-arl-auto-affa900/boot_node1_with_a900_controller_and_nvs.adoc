...
WARNING: *Tan pronto como la actualización de la controladora se complete en el par de alta disponibilidad, debe anular la definición del `kmip.init.maxwait` variable. Consulte link:ensure_new_controllers_are_set_up_correctly.html#unset_maxwait["Confirme que los nuevos controladores están configurados correctamente, paso 12"]. Si no lo hace, podría producirse una pérdida de datos si se produce una interrupción del suministro eléctrico.*

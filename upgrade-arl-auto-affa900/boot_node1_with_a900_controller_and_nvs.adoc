...
[cols="35,65"]
|===
| Controladora node1 existente | Sustitución de los módulos del sistema node1 
...
.Pasos
. (Solo actualización de AFF A800) En el aviso del CARGADOR, introduzca el modo de mantenimiento:
+
`boot_ontap maint`

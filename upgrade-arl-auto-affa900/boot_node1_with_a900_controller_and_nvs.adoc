...
[role="lead"]
node1 con los módulos de reemplazo está ahora listo para arrancar. Esta sección proporciona los pasos necesarios para arrancar node1 con los módulos de reemplazo para las siguientes configuraciones de actualización:

[cols="35,65"]
|===
| Controlador node1 antiguo | Sustitución de los módulos del sistema node1 


| AFF A220 configurado como ASA | Módulo controlador AFF A150 ^1^ 


| AFF A220
AFF A200
C190 de AFF | Módulo controlador AFF A150 ^1^ 


| FAS2620
FAS2720 | Módulo controlador FAS2820 ^1^ 


| AFF A700 configurado como ASA | Controladora ASA A900 y módulos NVRAM ^2^ 


| AFF A700 | Controladora AFF A900 y módulos NVRAM ^2^ 


| FAS9000 | Controladora FAS9500 y módulos NVRAM ^2^ 
|===
^1^ Al sustituir los módulos del controlador, se mueven todas las conexiones del módulo del controlador antiguo al módulo de reemplazo.
^2^ Al sustituir la controladora y los módulos NVRAM, solo se mueven las conexiones de consola y de gestión.

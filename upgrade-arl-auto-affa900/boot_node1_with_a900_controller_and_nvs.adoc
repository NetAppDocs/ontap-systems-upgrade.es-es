...
[role="lead"]
node1 con los módulos de reemplazo ya está listo para el arranque. Esta sección proporciona los pasos necesarios para arrancar node1 con los módulos de reemplazo para las siguientes configuraciones de actualización:
...
|===
^1^ La actualización al intercambiar el módulo del controlador implica mover todas las conexiones del módulo del controlador antiguo al módulo del controlador de reemplazo.
^2^ La actualización mediante el cambio de la controladora y los módulos NVRAM implica mover únicamente las conexiones de la consola y de gestión.

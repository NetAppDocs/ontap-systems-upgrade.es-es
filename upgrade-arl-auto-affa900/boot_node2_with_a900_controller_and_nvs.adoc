...
summary: Arranque el nodo 2 con el módulo de controlador AFF A900 y el módulo NVRAM. 
---
= Arranque el nodo 2 con el controlador AFF A900 o FAS9500 y los módulos NVRAM
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
El nodo 2 con el controlador AFF A900 o FAS9500 y los módulos NVRAM están ahora listos para la actualización. Una actualización de A700 de AFF a AFF A900 o de FAS9000 a FAS9500 intercambiando la controladora y los módulos NVRAM implica mover únicamente las conexiones de consola y de gestión. En esta sección se indican los pasos necesarios para arrancar el nodo 2 con el controlador AFF A900 o FAS9500 y los módulos NVRAM.

.Pasos
. [[boot_2_step1]]ajuste el `bootarg.storageencryption.support` y.. `kmip.init.maxwait` variables para evitar un bucle de arranque después de cargar la configuración 2.
+
...
. Reasigne los discos AFF A700 2 a AFF A900 2 introduciendo "22/7" y seleccionando la opción oculta `boot_after_controller_replacement` cuando el nodo se detiene en el menú de arranque.
+
...
.. Compruebe y restablezca los bootargs de cifrado de almacenamiento mencionados en <<A900_boot_node2,Paso 1>>.

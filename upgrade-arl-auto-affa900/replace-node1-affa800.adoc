...
summary: Sustituya los módulos del sistema AFF A800 node1 cuando utilice ARL para actualizar los modelos de controladoras en el mismo chasis. 
---
= Sustituya los módulos del controlador AFF A800
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
== Prepárese para extraer el módulo del controlador AFF A800
...
+
image::../media/drw_a800_drive_seated_IEOPS-960.png[Empuje la unidad para asentarla firmemente contra el plano medio del chasis]
...
== Retire el módulo del controlador AFF A800

Retire el dispositivo de gestión de cables del módulo del controlador AFF A800 y saque ligeramente la controladora del chasis.
...
+
image::../media/a800_cable_management.png[Quita la ARM de gestión de cables]
...
== Instale el módulo de controlador AFF A90 o AFF A70

Instale, cablee y conecte el módulo de controlador AFF A90 o AFF A70 en node1.

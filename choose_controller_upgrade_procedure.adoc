...
* link:upgrade/upgrade-decide-to-use-this-guide.html["Mover almacenamiento"]
+
Puedes actualizar sin interrupciones de un AFF A250 a un AFF A400 o de un FAS2820 a un sistema de sustitución convirtiendo los nodos originales en estanterías de unidades y luego conectando las estanterías de unidades a los nodos de sustitución para mover el almacenamiento a bordo.

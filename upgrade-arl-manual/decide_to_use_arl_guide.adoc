...
summary: Decidir si utilizar el procedimiento manual de ARL para actualizar controladoras de almacenamiento en un par de alta disponibilidad con controladoras nuevas que ejecuten ONTAP 9.7 o una anterior. 
---

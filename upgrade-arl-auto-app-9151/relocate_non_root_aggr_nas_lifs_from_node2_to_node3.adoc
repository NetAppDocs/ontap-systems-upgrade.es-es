...
.El futuro
Después de reubicar los agregados que no son raíz y los LIF de datos NAS del nodo2 al nodo3, link:relocate-failed-or-vetoed-aggr-node3.html["reubicar los agregados fallidos o vetados a node3"].

...
[role="lead"]
El proceso de sustitución del controlador comienza con una serie de comprobaciones previas. También reúnes información sobre los nodos originales para usarla más adelante en el procedimiento. Si falla alguna comprobación previa, debes corregir la propiedad de los agregados antes de poder continuar con la actualización.
...
....
. Selecciona `y`, verás el siguiente resultado:
+
....

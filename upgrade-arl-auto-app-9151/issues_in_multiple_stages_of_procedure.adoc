...
summary: 'Información sobre los problemas que pueden producirse al actualizar controladoras que ejecutan ONTAP 9.15.1 o una versión posterior mediante `system controller replace` comandos.' 
---

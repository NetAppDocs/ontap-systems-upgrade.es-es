...
summary: 'Si es necesario, configure el nuevo módulo de controladora para NVE o NAE cuando actualice las controladoras que ejecutan ONTAP 9.15.1 o posterior mediante comandos. `system controller replace`' 
---

...
** Para un sistema FAS70 y FAS90, ONTAP solo convierte la eficiencia del almacenamiento de los volúmenes Thin-Provisioning existentes que ya tenían activada la eficiencia del almacenamiento antes de la actualización.

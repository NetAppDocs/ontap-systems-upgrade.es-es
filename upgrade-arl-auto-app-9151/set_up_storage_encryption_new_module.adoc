...
summary: 'Si es necesario, configure el cifrado de almacenamiento, instale certificados de SSL y configure servidores de gestión de claves cuando actualice las controladoras que ejecuten ONTAP 9.15.1 o posterior con `system controller replace` comandos.' 
---
...
.El futuro
Después de configurar Storage Encryption en el nuevo módulo controlador, link:set_up_netapp_volume_encryption_new_module.html["configurar NetApp Volume o Aggregate Encryption en el nuevo módulo controlador"].

...
. Si el sistema entra en un bucle de reinicio con el mensaje `no disks found`, indica que se ha producido un problema con la reasignación del disco. Consulte link:troubleshoot_index.html["Solucionar problemas"] para resolver el problema.

...
. Introduce `Ctrl-C` durante el autoboot para detener el nodo en el `LOADER>` prompt.
...
.El futuro
Después de instalar y arrancar el nodo3, link:verify_node3_installation.html["verifica la instalación de node3"].

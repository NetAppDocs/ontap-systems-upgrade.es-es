...
summary: 'Reubicar manualmente los agregados fallidos o vetados en el nodo 2 al actualizar los controladores que ejecutan ONTAP 9.15.1 o posterior mediante `system controller replace` comandos.' 
---
...
.El futuro
Tras reubicar los agregados fallidos o vetados en el nodo2, link:retire_node1.html["retirar nodo1"].

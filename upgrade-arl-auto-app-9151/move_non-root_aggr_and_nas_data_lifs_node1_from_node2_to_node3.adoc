...
Los LIFs remotos gestionan el tráfico a los LUNs SAN durante el proceso de actualización. Mover los LIFs SAN no es necesario para la salud del cluster o del servicio durante la actualización. Los LIFs SAN no se mueven a menos que necesiten ser mapeados a nuevos puertos. Verificas que los LIFs estén saludables y localizados en los puertos apropiados después de poner en línea el nodo3.
...
.El futuro
Después de mover los agregados que no son raíz y los LIF de datos NAS propiedad del nodo1 del nodo2 al nodo3, link:relocate_non_root_aggr_nas_lifs_from_node2_to_node3.html["reubica los agregados que no son raíz y los LIF de datos NAS del nodo2 al nodo3"].

...
.El futuro
Después de restaurar la configuración del gestor de claves en el nodo4, link:move_non_root_aggr_and_nas_data_lifs_node2_from_node3_to_node4.html["mueve los agregados que no son raíz y los LIF de datos NAS propiedad de node2 de node3 a node4"].

...
+
Introduce la frase de contraseña y la información de copia de seguridad que registraste antes en el procedimiento. Consulta link:manage_storage_encryption_using_okm.html["Gestione el cifrado del almacenamiento con el gestor de claves incorporado"].

...
summary: 'Deje que NetApp sepa que el sistema antiguo ya no funciona después de actualizar las controladoras que ejecutan ONTAP 9.8 o una versión posterior mediante el uso `system controller replace` comandos.' 
---
...
.El futuro
Tras descomisionar el sistema antiguo, link:resume_snapmirror_operations.html["reanudar las operaciones SnapMirror"].

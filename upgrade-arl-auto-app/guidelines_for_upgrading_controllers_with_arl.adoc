...
* A controladores básicos con unidades internas, por ejemplo: un FAS2750.
+
...
.El futuro
Después de revisar las directrices para actualizar los controladores con ARL, link:verify_health_of_metrocluster_config.html["verificar la salud de la configuración de MetroCluster"].

...
^4^La siguiente tabla muestra las versiones de ONTAP compatibles para las combinaciones de actualización de controladoras.
...
| FAS2720 | 9.13.1 o posterior | FAS2820 | 9.13.1 o posterior 


| FAS2760 | 9.11.1P7 o anterior | FAS2820 | 9.13.1 o posterior 
...
.El futuro
Después de decidir si vas a utilizar este procedimiento ARL, infórmate sobre link:required_tools_and_documentation.html["herramientas y documentación necesarias"].

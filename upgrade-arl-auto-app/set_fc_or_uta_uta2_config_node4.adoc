...
Sin embargo, si tiene un sistema V-Series o tiene un software de virtualización FlexArray y está conectado a cabinas de almacenamiento, y node4 no tiene puertos FC integrados, puertos UTA/UTA2 integrados o una tarjeta UTA/UTA2, debe volver a _Install y arrancar node4_ y reanudar el procedimiento en link:install_boot_node4.html#step22["Paso 22"].
...
| Tiene discos de almacenamiento  a| 
** Omita esta sección y vaya a link:reassign-node2-disks-to-node4.html["Reasigne discos de node2 GB a node4"] si node4 no tiene una tarjeta UTA/UTA2 o los puertos UTA/UTA2 internos.
...
** Skip _Compruebe y configure los puertos UTA/UTA2 en node4_ si node4 no tiene una tarjeta UTA/UTA2 o puertos UTA/UTA2 internos, vuelva a _Install y arranque node4_, y reanude el procedimiento en link:install_boot_node4.html#auto_install4_step23["Paso 23"].
...
+
Si va a actualizar a un sistema A800, vaya a link:reassign-node2-disks-to-node4.html#reassign-node2-node4-app-step9["Reasigne los discos del nodo 2 al nodo 4, Paso 9"].

...
+
** Ve a <<check-config-uta-uta2-node4,Comprobar y configurar los puertos UTA/UTA2 en el nodo 4>> si el nodo4 tiene una tarjeta UTA/UTA2 o puertos UTA/UTA2 integrados.
...
== Paso 2: comprobar y configurar los puertos UTA/UTA2 en el nodo4

...
+
Si no dispone de una configuración FC o UTA/UTA2, asegúrese de link:reassign-node2-disks-to-node4.html#reassign-node1-node3-app-step1["Reasigne los discos node1 a node3, paso 1"]que node3 reconozca discos de node1.

...
.Pasos
. [[reassign-node1-node3-app-step1]]Verifique que el nodo1 se haya detenido en el menú de arranque.  Reasignar los discos del nodo1 al nodo3:
+
...
+
** Llevar a cabo<<reassign-node1-node3-app-step3,Paso 3>> a<<reassign-node1-node3-app-step8,Paso 8>> en el nodo 3
** Ir a la secciónlink:verify_node3_installation.html["Verifique la instalación del nodo 3"]
...
.El futuro
Tras reasignar los discos del nodo1 al nodo3, link:verify_node3_installation.html["verifica la instalación de node3"].

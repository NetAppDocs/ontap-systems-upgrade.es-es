...
Si los puertos físicos del nodo2 no se asignan directamente a los puertos físicos del nodo4, la sección posterior <<restore_network_configuration_on_node4,Restaurar la configuración de red en el nodo 4>> debe usarse para reparar la conectividad de red.
...
.El futuro
Tras verificar la instalación de node4, link:restore_key-manager_config_node4.html["restaurar la configuración del gestor de claves en node4"].

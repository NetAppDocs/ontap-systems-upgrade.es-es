...
summary: 'Reubicar manualmente los agregados fallidos o vetados en el nodo 3 al actualizar los controladores que ejecutan ONTAP 9.8 o posterior mediante `system controller replace` comandos.' 
---
...
.El futuro
Tras reubicar los agregados fallidos o vetados, link:retire_node2.html["retirar nodo2"].

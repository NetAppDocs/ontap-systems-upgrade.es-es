...
.El futuro
Tras restaurar la configuración del key-manager en el nombre de nodo node3, link:move_non-root_aggr_and_nas_data_lifs_node1_from_node2_to_node3.html["mueve los agregados que no son raíz y los LIF de datos NAS propiedad de node1 de node2 a node3"].

...
summary: 'Información sobre problemas que pueden producirse al actualizar controladoras que ejecutan ONTAP 9.8 o una versión posterior mediante `system controller replace` comandos.' 
---

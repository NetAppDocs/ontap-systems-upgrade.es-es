...
.El futuro
Después de gestionar la autenticación mediante servidores KMIP, link:ensure_new_controllers_are_set_up_correctly.html["confirma que los nuevos controladores están configurados correctamente"].

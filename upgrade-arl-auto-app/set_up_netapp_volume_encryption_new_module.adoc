...
.El futuro
Después de configurar NetApp Volume o Aggregate Encryption en el nuevo módulo controlador, link:decommission_old_system.html["decomisionar el antiguo sistema"].

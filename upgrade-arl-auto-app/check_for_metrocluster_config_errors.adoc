...
.El futuro
Después de comprobar si hay errores de configuración en MetroCluster, link:verify_switchover_healing_switchback.html["verifica la conmutación de sitios, la curación y la vuelta atrás"].

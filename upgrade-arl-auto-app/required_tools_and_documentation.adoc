...
.El futuro
Después de revisar las herramientas y la documentación necesarias, conoce la link:guidelines_for_upgrading_controllers_with_arl.html["Pautas para actualizar controladores con ARL"].

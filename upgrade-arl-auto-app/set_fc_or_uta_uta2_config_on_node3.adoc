...
* Sin embargo, si tiene un sistema V-Series o un sistema con el software de virtualización FlexArray con cabinas de almacenamiento, y node3 no tiene puertos FC integrados, puertos UTA/UTA integrados o una tarjeta UTA/UTA2, vuelva a _Install y arranque node3_ y reanude el procedimiento en link:install_boot_node3.html#auto_install3_step23["Paso 23"].
...
** Si node3 no tiene una tarjeta UTA/UTA2 o puertos UTA/UTA2 internos, omita _Check y configure los puertos UTA/UTA2 en node3_ y vaya a link:reassign-node1-disks-to-node3.html["Reasigne discos de node1 GB a node3"].
...
| Es un sistema V-Series o tiene software de virtualización FlexArray y se conecta a las cabinas de almacenamiento  a| 
** Si el nodo 3 tiene una tarjeta UTA/UTA2 o puertos UTA/UTA2 integrados, vaya a. <<Comprobar y configurar los puertos UTA/UTA2 en el nodo 3>>.
** Si node3 no tiene una tarjeta UTA/UTA2 o puertos UTA/UTA2 integrados, omita _Check y configure los puertos UTA/UTA2 en node3_ y vuelva a _Install y arranque node3_ y reanude el procedimiento en link:install_boot_node3.html#auto_install3_step23["Paso 23"].
...
| Es un sistema V-Series o tiene software de virtualización FlexArray y se conecta a las cabinas de almacenamiento | Vuelva a _Install e inicie node3_, y reanude el procedimiento link:install_boot_node3.html#auto_install3_step23["Paso 23"]. 
|===
. [[auto_check3_step13]]salir del modo de mantenimiento:
+
`halt`

. [[step14]]Inicie el nodo en el menú de inicio ejecutando `boot_ontap menu`. Si va a actualizar a un sistema AFF A800, vaya a link:reassign-node1-disks-to-node3.html#reassign-node1-node3-app-step9["Reasigne los discos node1 a node3, paso 9"].

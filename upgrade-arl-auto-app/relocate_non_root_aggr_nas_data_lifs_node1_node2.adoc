...
.El futuro
Después de reubicar los agregados que no son raíz y los LIF de datos NAS propiedad de node1 en node2, link:relocate-failed-or-vetoed-aggr-node2.html["reubicar agregados fallidos o vetados"].

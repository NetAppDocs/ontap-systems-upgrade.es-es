...
.El futuro
Tras restaurar la configuración del gestor de claves en el nodo2, link:verify-rcf-configuration.html["verifica la configuración de RCF en los conmutadores de clúster"].

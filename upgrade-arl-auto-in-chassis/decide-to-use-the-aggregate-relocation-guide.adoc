...
* Si prefieres un método diferente para actualizar el hardware del controlador y estás dispuesto a realizar movimientos de volúmenes, consulta link:other-references.html["Referencias"] para enlazar con _Actualización moviendo volúmenes o almacenamiento_.


.Información relacionada
Consulta link:other-references.html["Referencias"] para acceder a la _Documentación de ONTAP 9_.

.El futuro
Tras decidir utilizar este procedimiento ARL, link:required-tools-and-documentation.html["conoce las herramientas y la documentación necesarias"].

...
.El futuro
Tras restaurar la configuración del gestor de claves en el nodo1 actualizado, link:move-non-root-aggr-nas-lifs-node1-from-node2-to-upgraded-node1.html["mueve los agregados no raíz de node1 y las LIF de datos NAS de node2 al node1 actualizado"].

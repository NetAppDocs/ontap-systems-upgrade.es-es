...
---
= Instala el módulo controlador ASA A150, AFF A150 o FAS2820 en node2
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Instala el módulo de controlador ASA A150, AFF A150 o FAS2820 que recibiste para la actualización en node2. Node2 es el controlador B ubicado en el lado derecho del chasis cuando miras los controladores desde la parte trasera del sistema.

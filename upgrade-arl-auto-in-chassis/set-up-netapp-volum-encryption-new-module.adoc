...
summary: Si es necesario, configura el nuevo módulo controlador para NVE o NAE cuando uses ARL para actualizar modelos de controlador en el mismo chasis. 
---
...
.El futuro
Después de configurar NetApp Volume o Aggregate Encryption en el nuevo módulo controlador, link:decommission-old-system.html["decomisionar el antiguo sistema"].

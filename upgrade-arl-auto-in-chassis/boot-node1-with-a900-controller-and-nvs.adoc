...
+
Ingresa la frase de contraseña y la información de copia de seguridad que anotaste antes en el procedimiento. Consulta link:manage-storage-encryption-using-okm.html["Gestione el cifrado del almacenamiento con el gestor de claves incorporado"].

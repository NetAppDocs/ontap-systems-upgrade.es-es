...
[role="lead"]
El nodo 1 con los módulos de reemplazo ya está listo para arrancar.  Los módulos de reemplazo compatibles se enumeran en lalink:decide_to_use_the_aggregate_relocation_guide.html#supported-systems-in-chassis["matriz de sistemas compatibles"] .

...
Para obtener información detallada sobre las licencias, consulta link:other-references.html["Referencias"] para enlazar con la _System Administration Reference_.

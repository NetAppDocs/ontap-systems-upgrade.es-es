...
| HA | No es obligatorio | Los puertos HA no son necesarios para la actualización del nodo 1 | Los puertos HA no son necesarios para la actualización del nodo 1 
...
.El futuro
Después de cablear el nodo1 para cluster-HA y almacenamiento compartidos, link:boot-node1-with-a900-controller-and-nvs.html["arranca el node1 con los módulos de sistema de reemplazo"].

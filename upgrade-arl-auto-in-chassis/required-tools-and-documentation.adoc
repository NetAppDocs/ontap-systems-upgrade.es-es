...
Consulta link:other-references.html["Referencias"] para acceder a la lista de documentos de referencia y sitios de referencia necesarios para esta actualización.

.El futuro
Tras revisar las herramientas y la documentación necesarias, link:guidelines-for-upgrading-controllers-with-arl.html["conoce las directrices para actualizar los controladores"].

...
[role="lead"]
El Node2 con los módulos de reemplazo está ahora listo para arrancar. Los módulos de reemplazo soportados están listados en el link:decide-to-use-the-aggregate-relocation-guide.html#supported-systems-in-chassis["matriz de sistemas compatibles"].
...
.El futuro
Tras arrancar el nodo2 con los módulos de sistema sustituidos, link:verify-node2-installation.html["verifica la instalación del nodo2"].

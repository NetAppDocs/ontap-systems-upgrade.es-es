...
.Pasos
. Consulta link:other-references.html["Referencias"] para enlazar al _NetApp Support Site_ e iniciar sesión.
...
.El futuro
Tras descomisionar el sistema antiguo, link:resume-snapmirror-operations.html["reanudar las operaciones SnapMirror"].

...
---
= Sustituye el controlador AFF A700 o FAS9000 del nodo1 y los módulos NVRAM
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Sustituye el controlador y los módulos NVRAM del nodo1 AFF A700 o FAS9000 por el controlador y los módulos NVRAM ASA A900, AFF A900 o FAS9500.
...
Separa y retira el módulo controlador AFF A700 o FAS9000 del nodo1.
...
Desbloquea y quita el módulo NVRAM del node1 AFF A700 o FAS9000.
...
Instala, cablea y conecta el módulo NVRAM del ASA A900, AFF A900 o FAS9500 en node1.
...
== Paso 4: instala el módulo controlador ASA A900, AFF A900 o FAS9500 en node1

Instala, cablea y conecta el módulo controlador ASA A900, AFF A900 o FAS9500 en node1.
...
.El futuro
Después de instalar el controlador ASA A900, AFF A900 o FAS9500 y los módulos NVRAM, link:netboot-node1.html["netboot nodo1"].

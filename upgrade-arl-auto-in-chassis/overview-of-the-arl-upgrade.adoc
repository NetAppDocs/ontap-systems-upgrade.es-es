...
| link:verify-upgrade-hardware.html["Fase 1: Prepárese para la actualización"]  a| 
...
| link:relocate-non-root-aggr-and-nas-data-lifs-node1-node2.html["Etapa 2: Reubicar recursos y retirar node1"]  a| 
...
| link:relocate-non-root-aggr-nas-lifs-from-node2-to-node1.html["Etapa 4: Reubicar recursos y retirar node2"]  a| 
...
| link:install-aff-a30-a50-c30-c50-node2.html["Etapa 5: instala los módulos del sistema de sustitución del nodo2"]  a| 
...
| link:cable-node2-for-shared-cluster-HA-storage.html["Etapa 6: Arranque node2 con los módulos del sistema de reemplazo"]  a| 
...
|===
.El futuro
Después de conocer la secuencia de actualización de ARL, link:verify-upgrade-hardware.html["verifica el hardware de actualización"].

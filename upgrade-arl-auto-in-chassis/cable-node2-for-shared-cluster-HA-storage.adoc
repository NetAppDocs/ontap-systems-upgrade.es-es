...
.El futuro
Después de cablear el nodo2 para cluster-HA y almacenamiento compartidos, link:boot-node2-with-a900-controller-and-nvs.html["arranca el nodo2 con los módulos de sistema sustituidos"].

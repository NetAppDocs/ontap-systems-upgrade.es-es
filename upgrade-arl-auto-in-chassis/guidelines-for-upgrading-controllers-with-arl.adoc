...
Las actualizaciones del controlador son compatibles con determinadas configuraciones del sistema. Consulta la link:decide-to-use-the-aggregate-relocation-guide.html#supported-systems["Combinaciones de actualización del sistema admitidas"] para ver la lista de sistemas compatibles y la versión mínima de ONTAP.

Si has recibido un nuevo AFF A30, AFF A50, AFF A70, AFF A90, AFF A150, AFF A900, AFF C30, AFF C60, AFF C80, FAS2820 o FAS9500 como sistema completo, incluido un nuevo chasis, consulta link:other-references.html["Referencias"] para enlazar con _Use "system controller replace" commands to upgrade controller hardware running ONTAP 9.8 or later_.
...
Si ocurre algún problema, consulta la sección link:aggregate-relocation-failures.html["Solucionar problemas"] al final del procedimiento para más información y posibles soluciones. La información sobre los fallos que pueden ocurrir está enumerada por fase del procedimiento en el link:overview-of-the-arl-upgrade.html["Secuencia de actualización de ARL"].

Si no encuentra una solución al problema encontrado, comuníquese con el soporte técnico.

.El futuro
Después de revisar las directrices para actualizar los controladores, link:overview-of-the-arl-upgrade.html["conoce la secuencia de actualización de la ARL"].

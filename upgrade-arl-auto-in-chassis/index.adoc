...
* Este procedimiento es complejo y presupone que tienes habilidades avanzadas de administración de ONTAP. Debes leer y entender link:guidelines_for_upgrading_controllers_with_arl.html["Pautas para actualizar los controladores"] y link:overview_of_the_arl_upgrade.html["Secuencia de actualización de ARL"] antes de empezar la actualización.

...
Para quitar el módulo controlador node1, retira el dispositivo de gestión de cables y desbloquea los pestillos de bloqueo. Luego, quita el módulo controlador del chasis.

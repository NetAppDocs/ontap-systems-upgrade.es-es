...
---
= Sustituir el módulo controlador node1 AFF A250 o AFF C250
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Reemplaza el módulo controlador AFF A250 o AFF C250 del nodo1 por un módulo controlador AFF A30, AFF A50, AFF C30 o AFF C60.
...
Para quitar el módulo controlador node1, retira el dispositivo de gestión de cables y desbloquea los pestillos de bloqueo. Luego, saca el módulo controlador del chasis.
...
.El futuro
Después de instalar el módulo controlador AFF A30, AFF A50, AFF C30 o AFF C60, link:netboot-node1.html["netboot nodo1"].

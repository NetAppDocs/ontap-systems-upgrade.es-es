...
.El futuro
Después de configurar Storage Encryption en el nuevo módulo controlador, link:set-up-netapp-volum-encryption-new-module.html["configurar NetApp Volume o Aggregate Encryption en el nuevo módulo controlador"].

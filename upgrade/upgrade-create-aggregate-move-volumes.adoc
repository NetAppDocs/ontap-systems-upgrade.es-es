...
+
Tanto el nuevo agregado como el antiguo desde el que se mueve el volumen deben estar en la misma SVM.
...
.El futuro
link:upgrade-move-lifs-to-new-nodes.html["Mueva LIF de datos que no sean SAN y LIF de gestión de clúster a los nuevos nodos"]

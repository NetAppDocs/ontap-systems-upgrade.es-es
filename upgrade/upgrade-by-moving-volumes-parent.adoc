...
summary: Si estás actualizando moviendo volúmenes, preparas los nodos originales y unes los nuevos nodos al clúster. Mueves los volúmenes a los nuevos nodos, configuras los LIF y retiras los nodos originales del clúster. Actualizar moviendo volúmenes es una actualización no disruptiva. 
---
= Conoce cómo actualizar moviendo volúmenes
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Para actualizar moviendo volúmenes, prepare los nodos originales y una los nuevos nodos al clúster. Mueve volúmenes a los nuevos nodos, configura LIF y elimina los nodos originales del clúster.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-7.png["Siete"]link:upgrade-remove-original-nodes.html["Eliminar los nodos originales del clúster"]
[role="quick-margin-para"]
Una vez que los volúmenes se hayan trasladado a los nuevos nodos, elimine los nodos originales del clúster. Cuando se elimina un nodo, se borra la configuración del nodo y se inicializan todos los discos.

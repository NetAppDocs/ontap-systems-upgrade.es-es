...
* link:upgrade_aff_a250_to_aff_a400_ndu_upgrade_workflow.html["Conoce cómo convertir AFF A250 en una bandeja de discos y mover el almacenamiento a AFF A400"] (actualización no disruptiva)
* link:convert-to-drive-shelf.html["Actualiza desde AFF A150, AFF A220 o FAS2820 convirtiéndolo en un estante de unidad"] (actualización no disruptiva)

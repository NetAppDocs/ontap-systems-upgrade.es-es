...
summary: Después de convertir node1 en una estantería de unidades y conectarlo a node3, reasignas las unidades que antes pertenecían a node1 a node3. 
---
...
[role="lead"]
Reasigna al nodo3 las unidades que antes estaban asignadas al nodo1.

...
. Desde el menú de inicio, introduzca 8 para reiniciar el nodo y pulse *Ctrl-C* durante el inicio automático para detener el nodo en el símbolo del SISTEMA DEL CARGADOR.

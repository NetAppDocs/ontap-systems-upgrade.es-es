...
summary: Después de convertir node2 en un estante de unidades y conectarlo a node4, reasignas las unidades que antes pertenecían a node2 a node4. 
---
...
[role="lead"]
Reasigna las unidades que antes pertenecían a node2 a node4.

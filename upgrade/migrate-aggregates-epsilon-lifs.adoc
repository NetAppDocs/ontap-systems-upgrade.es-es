...
[role="lead"]
Migra los agregados de datos, épsilon e interfaces lógicas (LIF) en AFF A150, AFF A220 o FAS2820 nodo1 a nodo4.
...
.El futuro
link:convert-node1-to-drive-shelf.html["Convierta node1 en una bandeja de unidades y conéctela a node3"]

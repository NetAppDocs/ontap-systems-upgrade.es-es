...
.Pasos
. Enciende el nodo 3 y, luego, introduce inmediatamente Ctrl-C en el terminal de la consola para acceder al prompt LOADER.
+
...
+
Introduce el nombre de usuario/contraseña si aplica, o selecciona Intro para continuar.

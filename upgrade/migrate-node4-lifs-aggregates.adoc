...
summary: 'Para completar la actualización, conecta el nodo3 al nodo4 y luego migra las interfaces lógicas de datos (LIF) y los agregados de datos del nodo4 al nodo3.' 
---
...
[role="lead"]
Para completar la actualización, conecta el nodo3 al nodo4 y luego migra las interfaces lógicas de datos (LIF) y los agregados de datos del nodo4 al nodo3.

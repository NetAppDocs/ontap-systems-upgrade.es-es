...
+
Si no dispone de una configuración FC o UTA/UTA2, asegúrese de link:reassign-node1-disks-to-node3.html#reassign-node1-node3-step1["Reasigne los discos node1 a node3, paso 1"] que node3 reconozca discos de node1.

. [[auto9597_istall3_step29]]Para obtener una configuración MetroCluster, visite los sistemas y sistemas V-Series con el software de virtualización FlexArray conectado a cabinas de almacenamiento, visite la link:reassign-node1-disks-to-node3.html#reassign-node1-node3-step1["Reasigne los discos node1 a node3, paso 1"].

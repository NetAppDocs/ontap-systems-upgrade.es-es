...
| link:https://docs.netapp.com/us-en/ontap-cli/index.html["Referencia de comandos de ONTAP 9"^] | Describe la sintaxis y el uso de los comandos ONTAP compatibles. 

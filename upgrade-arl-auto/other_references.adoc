...
| link:https://docs.netapp.com/us-en/ontap-systems-upgrade/upgrade-arl-auto-affa900/index.html["Utilice los comandos "system Controller replace" para actualizar AFF A700 a AFF A900 o FAS9000 a FAS9500 con ONTAP 9.10.1 o posterior"^] | Describe los procedimientos de reubicación de agregados necesarios para actualizar sin interrupciones un sistema A700 de AFF a un sistema AFF A900 o un FAS9000 a un sistema FAS9500 que ejecute ONTAP 9.10.1 o una versión posterior mediante los comandos de "sustitución de controladora del sistema". 

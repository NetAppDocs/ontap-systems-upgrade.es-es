...
Sin embargo, no es necesario reiniciar el sistema las controladoras si se instala la misma versión de ONTAP 9 en ellas que se instalan en las controladoras originales. Si es así, puede omitir esta sección y continuar a. link:stage_3_install_boot_node3_overview.html["Fase 3 instalar y arrancar el nodo 3"]

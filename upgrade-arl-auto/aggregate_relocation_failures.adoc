...
summary: 'Solucione problemas de errores de reubicación de agregados que se pueden producir durante la actualización de controladoras que ejecutan ONTAP 9.5 a 9.7 mediante el uso `system controller replace` comandos.' 
---

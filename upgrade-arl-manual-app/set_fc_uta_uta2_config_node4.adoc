...
.El futuro
Después de establecer la configuración FC o UTA/UTA2 en el nodo4, link:map_ports_node2_node4.html["asignar puertos del nodo2 al nodo4"].

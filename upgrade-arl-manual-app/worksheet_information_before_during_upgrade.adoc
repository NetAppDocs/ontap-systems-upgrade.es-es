...
[role="lead"]
Debe recopilar cierta información para actualizar correctamente los nodos originales. Esta información incluye los ID de nodo, detalles del puerto y LIF, claves de licencia y direcciones IP.

Puede utilizar la siguiente hoja de trabajo para registrar información para utilizarla más adelante en el procedimiento:

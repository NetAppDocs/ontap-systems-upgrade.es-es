...
|===
.El futuro
Tras registrar la información del nodo original, link:determine_aggregates_on_internal_drives.html["determinar si el controlador tiene agregados en las unidades de disco internas"].

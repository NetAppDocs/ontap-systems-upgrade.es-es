...
Para más información sobre los comandos de reubicación de agregados de almacenamiento, consulta link:other_references.html["Referencias"] para enlazar a _Disk and aggregate management with the CLI_ y la _ONTAP 9 Command reference_.
...
.El futuro
Tras reubicar los agregados no raíz del nodo2 desde el nodo3 al nodo4, link:manage_authentication_kmip.html["gestionar la autenticación mediante servidores KMIP"].

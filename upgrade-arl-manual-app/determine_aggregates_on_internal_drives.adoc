...
.El futuro
Después de determinar si el controlador tiene agregados en las unidades de disco internas, link:prepare_nodes_for_upgrade.html["preparar los nodos para la actualización"].

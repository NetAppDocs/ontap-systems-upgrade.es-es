...
+
Ingresa la frase de contraseña y la información de copia de seguridad que anotaste antes en el procedimiento. Consulta link:manage_authentication_okm.html["Gestione claves de autenticación mediante el gestor de claves incorporado"].
...
+
El `disk reassign` comando reasigna solo aquellos discos cuyo propietario actual es `_node2_sysid_`.
...
.El futuro
Después de instalar y arrancar node4, link:set_fc_uta_uta2_config_node4.html["Establecer la configuración FC o UTA/UTA2 en el nodo 4"].

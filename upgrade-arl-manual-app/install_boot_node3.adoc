...
. Introduce CTRL-C para mostrar el menú de arranque.
...
.El futuro
Después de instalar y arrancar node3, link:set_fc_uta_uta2_config_node3.html["Establecer la configuración FC o UTA/UTA2 en el nodo 3"].

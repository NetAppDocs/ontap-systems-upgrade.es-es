...
.El futuro
Tras revisar las herramientas y la documentación necesarias, link:worksheet_information_before_during_upgrade.html["registrar la información del nodo original para utilizarla durante la actualización"].

...
+
Los dominios de difusión deben asignarse a los nuevos puertos del nuevo controlador más adelante en el procedimiento.
...
.El futuro
Tras registrar la información del nodo1, link:retire_node1.html["retirar nodo1"].

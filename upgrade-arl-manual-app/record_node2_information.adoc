...
NOTE: Es posible que tu sistema no tenga LIFs intercluster. Tienes un LIF de administración de cluster solo en un nodo de un par de nodos. Un LIF de administración de cluster se muestra en la salida de ejemplo de link:record_node1_information.html#step1["Paso 1"] en _Record node1 port information_.
...
+
Los dominios de difusión deben asignarse a los puertos del nuevo controlador más adelante en el procedimiento.
...
.El futuro
Tras registrar la información del nodo2, link:retire_node2.html["retirar nodo2"].

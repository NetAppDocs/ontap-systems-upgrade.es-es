...
.El futuro
Después de configurar Storage Encryption en el nuevo módulo controlador, link:set_up_netapp_encryption_on_new_controller.html["configurar NetApp Volume o Aggregate Encryption en el nuevo módulo controlador"].
